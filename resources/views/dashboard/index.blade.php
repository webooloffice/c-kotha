             ...
             <div class="card-body">
              <div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
               <div class="d-flex align-items-center me-auto ps-2">
                ...
                <div>
                 <h4 class="mb-sm-2 mb-1"><a href="doctor" class="text-black">Dr. Samantha Queque</a></h4>
              ...
              <div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
               <div class="d-flex align-items-center me-auto ps-2">
                ...
                <div>
                 <h4 class="mb-sm-2 mb-1"><a href="doctor" class="text-black">Dr. Samuel Jr.</a></h4>
                 <span class="fs-14 text-primary font-w600">Gynecologist</span>
                </div>
               </div>
               <div class="text-sm-end mt-sm-0 mt-3 star-review">
              ...
              <div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
               <div class="d-flex align-items-center me-auto ps-2">
                ...
                <div>
                 <h4 class="mb-sm-2 mb-1"><a href="doctor" class="text-black">Dr. Jennifer Ruby</a></h4>
                 <span class="fs-14 text-primary font-w600">Gynecologist</span>
                </div>
               </div>
               <div class="text-sm-end mt-sm-0 mt-3 star-review">
              ...
              <div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
               <div class="d-flex align-items-center me-auto ps-2">
                ...
                <div>
                 <h4 class="mb-sm-2 mb-1"><a href="doctor" class="text-black">Dr. Abdul Aziz Lazis</a></h4>
                 <span class="fs-14 text-primary font-w600">Gynecologist</span>
                </div>
               </div>
               <div class="text-sm-end mt-sm-0 mt-3 star-review">
              ...
              <div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
               <div class="d-flex align-items-center me-auto ps-2">
                ...
                <div>
                 <h4 class="mb-sm-2 mb-1"><a href="doctor" class="text-black">Dr. Alex Siauw</a></h4>
                 <span class="fs-14 text-primary font-w600">Gynecologist</span>
                </div>
               </div>
               <div class="text-sm-end mt-sm-0 mt-3 star-review">
           ...
           <div class="col-xl-12">
            <div class="card patient-activity">
               ...
               <table class="table table-responsive-sm">
                <tbody>
                 <tr>
                  <td>
                   <div class="d-flex">
                    <img src="images/users/6.jpg" alt="" class="img-2 me-3">
                    <div>
                     <h6 class="fs-16 mb-1"><a href="patient" class="text-black">Roby Romeo</a></h6>
                 ...
                 <tr>
                  <td>
                   <div class="d-flex">
                    <img src="images/users/7.jpg" alt="" class="img-2 me-3">
                    <div>
                     <h6 class="fs-16 mb-1"><a href="patient" class="text-black">Angela Nurhayati</a></h6>
                 ...
                 <tr>
                  <td>
                   <div class="d-flex">
                    <img src="images/users/8.jpg" alt="" class="img-2 me-3">
                    <div>
                     <h6 class="fs-16 mb-1"><a href="patient" class="text-black">James Robinson</a></h6>
                     <span class="fs-14">41 Years Old</span>
                    </div>
                   </div>
                  </td>
                 ...
                 <tr>
                  <td>
                   <div class="d-flex">
                    <img src="images/users/9.jpg" alt="" class="img-2 me-3">
                    <div>
                     <h6 class="fs-16 mb-1"><a href="patient" class="text-black">Thomas Jaja</a></h6>
                 ...
                 <tr>
                  <td>
                   <div class="d-flex">
                    <img src="images/users/10.jpg" alt="" class="img-2 me-3">
                    <div>
                     <h6 class="fs-16 mb-1"><a href="patient" class="text-black">Cindy Brownleee</a></h6>
                 ...
                 <tr>
                  <td>
                   <div class="d-flex">
                    <img src="images/users/11.jpg" alt="" class="img-2 me-3">
                    <div>
                     <h6 class="fs-16 mb-1"><a href="patient" class="text-black">Oconner Jr.</a></h6>
             ...
             <div class="card-footer text-center border-0">
              <a href="patient" class="btn-link text-primary">See More >></a>
             </div>
            </div>
           </div>
          </div>
