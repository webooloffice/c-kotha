                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="email"
                                                class="mb-1 col-form-label text-md-end text-white"><strong>Email</strong></label>
                                        ...
                                        <div class="form-group">
                                            <label for="password"
                                                class="mb-1 text-white col-form-label text-md-end"><strong>Password</strong></label>
                                        ...
                                        <div class="text-center">
                                            <button type="submit"
                                                class="btn bg-white text-primary btn-block">{{ __('Login') }}</button>
                                        </div>
                                    </form>
